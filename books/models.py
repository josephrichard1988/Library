...
class books(models.Model):
    ...
    book_publisher = models.ForeignKey(publishers, on_delete=models.SET_NULL, null=True)
...
class author_books(models.Model):
    ...
    author = models.ForeignKey(author_model.author, on_delete=models.SET_NULL, null=True)
